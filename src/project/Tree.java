...
{
	private Node<E> root;	//refers to the beginning of the tree
	...
	//searches for a specific node using key
	...
	//successor the one thats supposed to replace the deleted node - for delete
